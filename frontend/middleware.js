...
const JWT_SECRET = process.env.JWT_SECRET_KEY || process.env.NEXT_PUBLIC_JWT_SECRET || 'fallback-secret-only-for-development';
...
// Use the explicitly controlled client token first
    const token = tokenCookie || userJwtCookie || headerToken;
